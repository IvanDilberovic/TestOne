...
//}
//
//static void train_lenet(const string &data_dir_path, double learning_rate, const int n_train_epochs, const int n_minibatch, core::backend_t backend_type)
//{
...
//	tiny_dnn::timer t;
//
//	optimizer.alpha *= std::min(tiny_dnn::float_t(4), static_cast<tiny_dnn::float_t>(sqrt(n_minibatch) * learning_rate));
//
//	int epoch = 1;
//
//	// create callback
...
//
//	nn.save("D:\\Projects\\Test\\TestOne\\TestOne\\Training-model-two", tiny_dnn::content_type::weights_and_model, tiny_dnn::file_format::json);
//
...
//	int epochs = 30;
//	std::string data_path = "D:\\Projects\\Test\\TestOne\\TestOne\\data";
//	//std::string _pathToModel = "ModelSaver";
//	int minibatch_size = 15;
